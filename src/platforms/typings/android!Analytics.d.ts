	...
	export module segment {
		export module analytics {
			export class Cartographer {
				public fromJson(param0: javaioReader): javautilMap<any,any>;
				public toJson(param0: javautilMap<any,any>, param1: javaioWriter): void;
				public toJson(param0: javautilMap<any,any>): string;
				public fromJson(param0: string): javautilMap<any,any>;
			}
	...
	export module segment {
		export module analytics {
			export class GetAdvertisingIdTask {
				public onPostExecute(param0: androidutilPair<any,any>): void;
				public doInBackground(param0: native.Array<androidcontentContext>): androidutilPair<any,any>;
			}
		}
	}
}
	...
	export module segment {
		export module analytics {
			export class Options {
				...
				public setIntegrationOptions(param0: string, param1: javautilMap<any,any>): com.segment.analytics.Options;
				public setIntegrationOptions(param0: com.segment.analytics.Analytics.BundledIntegration, param1: javautilMap<any,any>): com.segment.analytics.Options;
				...
				public integrations(): javautilMap<any,any>;
				public constructor();
			}
		}
	}
		...
		export module analytics {
			...
			export module ProjectSettings {
				export class Cache extends com.segment.analytics.ValueMap.Cache {
					public create(param0: javautilMap<any,any>): com.segment.analytics.ProjectSettings;
				}
			}
		}
	}
	...
	export module segment {
		export module analytics {
			export class Properties extends com.segment.analytics.ValueMap {
				...
				public products(): javautilList<any>;
				...
				public products(param0: native.Array<com.segment.analytics.Properties.Product>): javautilList<any>;
				public name(): string;
				public sku(): string;
	...
	export module segment {
		export module analytics {
			export class StatsSnapshot {
				...
				public integrationOperationDurationByIntegration: javautilMap<any,any>;
				public toString(): string;
				public constructor(param0: number, param1: number, param2: number, param3: number, param4: number, param5: javautilMap<any,any>);
			}
		}
	}
}
	...
	export module segment {
		export module analytics {
			...
			export module Traits {
				...
				export class Cache extends com.segment.analytics.ValueMap.Cache {
					public create(param0: javautilMap<any,any>): com.segment.analytics.Traits;
				}
			}
		}
	}
	...
	export module segment {
		export module analytics {
			export class ValueMap {
				...
				public getEnum(param0: javalangClass<any>, param1: string): javalangEnum<any>;
				public getList(param0: javalangObject, param1: javalangClass<any>): javautilList<any>;
				public toStringMap(): javautilMap<any,any>;
				public constructor();
				public containsValue(param0: javalangObject): boolean;
				public putAll(param0: javautilMap<any,any>): void;
				...
				public keySet(): javautilSet<any>;
				public getLong(param0: string, param1: number): number;
				public equals(param0: javalangObject): boolean;
				public putValue(param0: string, param1: javalangObject): com.segment.analytics.ValueMap;
				public getValueMap(param0: string, param1: javalangClass<any>): com.segment.analytics.ValueMap;
				public values(): javautilCollection<any>;
				public constructor(param0: number);
				public remove(param0: javalangObject): javalangObject;
				public entrySet(): javautilSet<any>;
			...
			export module integrations {
				...
				export module AliasPayload {
					export class Builder extends com.segment.analytics.integrations.BasePayload.Builder {
						...
						public realBuild(param0: string, param1: javautilDate, param2: javautilMap<any,any>, param3: javautilMap<any,any>, param4: string, param5: string): com.segment.analytics.integrations.AliasPayload;
					}
				}
			}
		}
			...
			export module integrations {
				...
				export module BasePayload {
					export abstract class Builder {
						public integration(param0: string, param1: javautilMap<any,any>): com.segment.analytics.integrations.BasePayload.Builder;
						public integrations(param0: javautilMap<any,any>): com.segment.analytics.integrations.BasePayload.Builder;
						public anonymousId(param0: string): com.segment.analytics.integrations.BasePayload.Builder;
						public context(param0: javautilMap<any,any>): com.segment.analytics.integrations.BasePayload.Builder;
		...
		export module analytics {
			export module integrations {
				export class GroupPayload extends com.segment.analytics.integrations.BasePayload {
					...
					public constructor();
					public constructor(param0: javautilMap<any,any>);
					public constructor(param0: string, param1: javautilDate, param2: javautilMap<any,any>, param3: javautilMap<any,any>, param4: string, param5: string, param6: string, param7: javautilMap<any,any>);
					public toBuilder(): com.segment.analytics.integrations.BasePayload.Builder;
					public constructor(param0: number);
				...
				export module GroupPayload {
					export class Builder extends com.segment.analytics.integrations.BasePayload.Builder {
						...
						public realBuild(param0: string, param1: javautilDate, param2: javautilMap<any,any>, param3: javautilMap<any,any>, param4: string, param5: string): com.segment.analytics.integrations.GroupPayload;
						public traits(param0: javautilMap<any,any>): com.segment.analytics.integrations.GroupPayload.Builder;
					}
				}
			}
		}
		...
		export module analytics {
			export module integrations {
				...
				export module IdentifyPayload {
					export class Builder extends com.segment.analytics.integrations.BasePayload.Builder {
						public constructor();
						public traits(param0: javautilMap<any,any>): com.segment.analytics.integrations.IdentifyPayload.Builder;
					}
				}
			}
		}
		...
		export module analytics {
			export module integrations {
				...
				export module ScreenPayload {
					export class Builder extends com.segment.analytics.integrations.BasePayload.Builder {
						public constructor();
						public properties(param0: javautilMap<any,any>): com.segment.analytics.integrations.ScreenPayload.Builder;
						public realBuild(param0: string, param1: javautilDate, param2: javautilMap<any,any>, param3: javautilMap<any,any>, param4: string, param5: string): com.segment.analytics.integrations.ScreenPayload;
			...
			export module integrations {
				...
				export module TrackPayload {
					export class Builder extends com.segment.analytics.integrations.BasePayload.Builder {
						...
						public properties(param0: javautilMap<any,any>): com.segment.analytics.integrations.TrackPayload.Builder;
						public constructor();
						public realBuild(param0: string, param1: javautilDate, param2: javautilMap<any,any>, param3: javautilMap<any,any>, param4: string, param5: string): com.segment.analytics.integrations.TrackPayload;
					}
				}
			}
		}
		...
		export module analytics {
			export module internal {
				export class Utils {
					...
					public static immutableCopyOf(param0: javautilMap<any,any>): javautilMap<any,any>;
					public static getResourceString(param0: androidcontentContext, param1: string): string;
					public static transform(param0: javautilMap<any,any>, param1: javautilMap<any,any>): javautilMap<any,any>;
					...
					public static isNullOrEmpty(param0: javautilMap<any,any>): boolean;
					...
					public static immutableCopyOf(param0: javautilList<any>): javautilList<any>;
					...
					public static toJsonObject(param0: javautilMap<any,any>): orgjsonJSONObject;
					...
					public static assertNotNullOrEmpty(param0: javautilMap<any,any>, param1: string): javautilMap<any,any>;
					public static copySharedPreferences(param0: androidcontentSharedPreferences, param1: androidcontentSharedPreferences): void;
					public static newSet(param0: native.Array<javalangObject>): javautilSet<any>;
